      ...
      {activeTab === 'reports' && (
          <div className="animate-in fade-in space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xl"><h3 className="text-gray-400 font-bold text-[10px] uppercase tracking-widest mb-1">{t('confirmation_rate')}</h3><p className="text-2xl font-black text-gray-900">{metrics.fulfillmentRate.toFixed(1)}%</p></div>
                  <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xl"><h3 className="text-gray-400 font-bold text-[10px] uppercase tracking-widest mb-1">{t('active_shipments')}</h3><p className="text-2xl font-black text-gray-900">{metrics.statusCounts.pending}</p></div>
                  <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xl"><h3 className="text-gray-400 font-bold text-[10px] uppercase tracking-widest mb-1">{t('returns_filed')}</h3><p className="text-2xl font-black text-pink-600">{metrics.statusCounts.returns}</p></div>
              </div>

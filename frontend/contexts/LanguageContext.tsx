...
const translations: Record<string, { en: string; ar: string }> = {
  ...
  'nav_modules': { en: 'Modules', ar: 'الوحدات' },
  'modules_title': { en: 'Modules & Plan', ar: 'الوحدات والخطة' },
  'modules_subtitle': { en: 'Your core is free forever. Add modules any time — monthly, quarterly or yearly.', ar: 'الأساسيات مجانية دائماً. أضف الوحدات في أي وقت — شهرياً أو ربع سنوي أو سنوي.' },
  'have_a_code': { en: 'Have a code?', ar: 'لديك رمز؟' },
  'redeem': { en: 'Redeem', ar: 'استخدام' },
  ...
  'promo_codes': { en: 'Promo Codes', ar: 'رموز الخصم' },
